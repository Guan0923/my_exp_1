...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        folder_path = "results/train/"+self.args.model+"/"+self.args.model_id+"/"
        ...
        visual(train_loss_total, name=os.path.join(folder_path, 'train_loss.pdf'))
        visual(vali_loss_total, name=os.path.join(folder_path, 'vali_loss.pdf'))
        visual(test_loss_total, name=os.path.join(folder_path, 'test_loss.pdf'))
